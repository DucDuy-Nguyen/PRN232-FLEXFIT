...
namespace Flexfit.Controllers
{
    ...
    public class PromotionController : ControllerBase
    {
        ...
        /// </summary>
        [HttpPost]
        [Authorize(Roles = "Admin")] // Chặn quyền, chỉ cho phép nhân viên/quản trị viên tạo
        ...
        /// </summary>
        [HttpDelete("{id:guid}")]
        [Authorize(Roles = "Admin")] // Chỉ có Admin tối cao mới được quyền xóa cấu trúc dữ liệu này
