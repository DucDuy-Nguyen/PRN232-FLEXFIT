...
using FlexFit.Engagement.Infrastructure.Hubs;
...
public class NotificationService : INotificationService
{
    ...
    private readonly IEngagementUserRepository _userRepo;
    private readonly IHubContext<NotificationHub> _hubContext;

    public NotificationService(
        INotificationRepository notificationRepo,
        IEngagementUserRepository userRepo,
    ...
    public async Task<bool> SendAdminNotificationAsync(AdminCreateNotificationRequest request)
    {
        ...
        {
            var allUserIds = await _userRepo.GetAllUserIdsAsync();
