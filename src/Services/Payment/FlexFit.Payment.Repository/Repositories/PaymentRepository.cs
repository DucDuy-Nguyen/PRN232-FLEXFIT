...
namespace FlexFit.Payment.Repository.Repositories
{
    public class PaymentRepository : IPaymentRepository
    {
        ...
        public async Task<Entities.Payment?> GetPaymentByTransactionCodeAsync(string providerTransactionCode)
        {
            return await _context.Payments
                .Include(p => p.Package)
        ...
        public async Task<IEnumerable<Entities.Payment>> GetPaymentsByUserIdAsync(Guid userId)
        {
            return await _context.Payments
                .Include(p => p.Package)
