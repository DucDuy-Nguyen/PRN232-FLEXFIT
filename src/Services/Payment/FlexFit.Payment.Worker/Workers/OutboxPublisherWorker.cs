...
namespace FlexFit.Payment.Worker.Workers
{
                    ...
                    using (var scope = _serviceProvider.CreateScope())
                    {
                        ...
                        foreach (var message in messages)
                        {
                            ...
                            try
                            {
                                ...
                                // Our RedisEventPublisher takes object eventPayload. We can deserialize the JSON payload back to a JsonElement first.
