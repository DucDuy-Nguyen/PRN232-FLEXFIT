...
using FlexFit.Payment.Contracts.Events;

namespace FlexFit.Payment.Application.Services
{
    public class CreditService : ICreditService
    {
        ...
        public async Task BuyPackageAsync(Guid packageId, BuyCreditPackageRequest request)
        {
            ...
            try
            {
                // BuyPackage test mock transaction is idempotent per package transaction mock ID
