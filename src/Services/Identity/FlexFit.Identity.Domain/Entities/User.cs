using FlexFit.Identity.Domain.Common;
...
///
/// ID type: Guid (matches monolith UserId — uniqueidentifier in SQL Server)
/// PK constraint: PK__Users__1788CC4C75B61DB2
/// Unique index: Email — UQ__Users__A9D1053421A327A4
///
/// Navigation properties that exist in the monolith but are NOT included here
/// because they belong to other bounded contexts:
///   - GymBookings, ClassBookings, CheckInLogs  → Booking Service
///   - Payments, CreditTransactions, UserCredit  → Payment Service
///   - Notifications, Reviews, FavoriteGyms      → Engagement Service
///   - Gyms (OwnerId), BranchStaffs              → Catalog Service
///
/// Only Identity-scoped navigation properties are kept:
///   - UserRoles
///   - MemberProfile
/// </summary>
public sealed class User : AggregateRoot
{
    ...
    // New verification tokens use Redis IOtpCacheService and do not write to SQL.
    // These will be removed in a subsequent migration.
